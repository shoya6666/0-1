...
int WINAPI WinMain(HINSTANCE, HINSTANCE, LPSTR, int) {
	...
	while (Novice::ProcessMessage() == 0) {
		...
		MatrixScreenPrintf(0, 0, rotateXMtrix, "rotateXMtrix");
		MatrixScreenPrintf(0, kRowHeight * 5, rotateYMtrix, "rotateYMtrix");
		MatrixScreenPrintf(0, kRowHeight * 5 * 2, rotateZMtrix, "rotateZMtrix");
		MatrixScreenPrintf(0, kRowHeight * 5 * 3, rotateXYZMtrix, "rotateXYZMtrix");
